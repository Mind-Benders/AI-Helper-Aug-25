...
const AuthPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Navigate to dashboard or home after successful auth
      console.log('Authentication successful');
      navigate('/dashboard'); // Example: navigate to dashboard on success
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-slate-950 to-gray-950 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-purple-600/10 blur-3xl"></div>
      </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            {isLogin 
              ...
              : 'Join us to revolutionize your workflow'
            }
          </p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="space-y-6">
            ...
            {isLogin && (
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="w-4 h-4 text-blue-600 bg-transparent border-gray-300 rounded focus:ring-blue-500" />
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-950 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
              {isLoading ? (
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center px-4 py-3 border border-white/10 rounded-lg text-white hover:bg-white/5 transition-all duration-200">
